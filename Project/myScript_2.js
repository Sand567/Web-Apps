...
function doCompletion() {
	...
	var url = "http://localhost:8999/Project/autocomplete?action=complete&id="+ escape(completeField.value);
    req = initRequest();
...
function parseMessages(responseXML) {
    ...
    if (responseXML == null) {
        ...
        var products = responseXML.getElementsByTagName("menus")[0];
        ...
        if (products.childNodes.length > 0) {
            ...
            for (loop = 0; loop <  products.childNodes.length; loop++) {
                ...
                var productName = product.getElementsByTagName("iname")[0];
                var productId = product.getElementsByTagName("itemid")[0];

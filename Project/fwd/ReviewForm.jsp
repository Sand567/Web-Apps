...
function reviewsubmit(){
	...
	MyMongoUtilities.insertReview(menuitem,location,username,reviewcomment,rating,reviewdate);
}
</script>

<form onsubmit="reviewsubmit();">
<h3>MenuItem: <input type = "text/html" name="menuitem"></h3>
<h3>Location: <input type = "text/html" name="menuitem"></h3>
<h3>Username: <input type = "text/html" name="menuitem"></h3>
<h3>Rating: <input type = "text/html" name="menuitem"></h3>
<h3>ReviewComment: <input type = "text/html" name="menuitem"></h3>
<h3>ReviewDate : <input type="date" name = "date" /></h3>
<input class="submit" type="submit" value="Write  A Review">    
</form>
<br><br><br>
</div>
</section>
